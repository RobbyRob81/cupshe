...
- (void) processResponseData:(NSData *)theResponse
{
	...
	switch (requestType) {
        ...
        case TESTACCOUNT_CAPTCHA_REQUEST:
        {
            ...
            //CIM
        case CREATE_CUSTOMER_PROFILE_REQUEST:
        {
            NSLog(@"CreateCustomerProfile Response");
            NSLog(@"%@", responseString);
            CreateCustomerProfileResponse *r = [CreateCustomerProfileResponse parseCreateCustomerProfileResponse:theResponse];
            self.response = r;
            if (r == nil) {
                self.response = [CreateCustomerProfileResponse createCustomerProfileResponse];
                self.response.errorType = SERVER_ERROR;
                self.response.responseReasonText = responseString;
            ...
            if ([self.response.anetApiResponse.messages.resultCode isEqualToString:@"Ok"] &&
                [self.delegate respondsToSelector:@selector(createCustomerProfileSucceeded:)]) {
                [self.delegate createCustomerProfileSucceeded:r];
            } else {
                [self.delegate requestFailed:self.response];
            ...
            break;
        case CREATE_CUSTOMER_PAYMENT_PROFILE_REQUEST:
        {
            NSLog(@"CreateCustomerProfile Response");
            NSLog(@"%@", responseString);
            CreateCustomerPaymentProfileResponse *r = [CreateCustomerPaymentProfileResponse parseCreateCustomerPaymentProfileResponse:theResponse];
            self.response = r;
            if (r == nil) {
                self.response = [CreateCustomerPaymentProfileResponse createCustomerPaymentProfileResponse];
                self.response.errorType = SERVER_ERROR;
                self.response.responseReasonText = responseString;
            }
            if ([self.response.anetApiResponse.messages.resultCode isEqualToString:@"Ok"] &&
                [self.delegate respondsToSelector:@selector(createCustomerPaymentProfileSucceeded:)]) {
                [self.delegate createCustomerPaymentProfileSucceeded:r];
            }
        }
            break;
        case CREATE_CUSTOMER_SHIPPING_ADDRESS_REQUEST:
        {
            NSLog(@"CreateCustomerShippingAddressResponse Response");
            NSLog(@"%@", responseString);
            CreateCustomerShippingAddressResponse *r = [CreateCustomerShippingAddressResponse parseCreateCustomerShippingAddressResponse:theResponse];
            self.response = r;
            if (r == nil) {
                self.response = [CreateCustomerShippingAddressResponse createCustomerShippingAddressResponse];
                self.response.errorType = SERVER_ERROR;
                self.response.responseReasonText = responseString;
            }
            if ([self.response.anetApiResponse.messages.resultCode isEqualToString:@"Ok"] &&
                [self.delegate respondsToSelector:@selector(createCustomerShippingAddressSucceeded:)]) {
                [self.delegate createCustomerShippingAddressSucceeded:r];
            }
        }
            break;
        case CREATE_CUSTOMER_PROFILE_TRANSACTION:
        {
            NSLog(@"CreateCustomerProfileTransactionResponse Response");
            NSLog(@"%@", responseString);
            CreateCustomerProfileTransactionResponse *r = [CreateCustomerProfileTransactionResponse parseCreateCustomerProfileTransactionResponse:theResponse];
            self.response = r;
            if (r == nil) {
                self.response = [CreateCustomerProfileTransactionResponse createCustomerProfileTransactionResponse];
                self.response.errorType = SERVER_ERROR;
                self.response.responseReasonText = responseString;
            }
            if ([self.response.anetApiResponse.messages.resultCode isEqualToString:@"Ok"] &&
                [self.delegate respondsToSelector:@selector(createCustomerProfileTransactionSucceeded:)]) {
                [self.delegate createCustomerProfileTransactionSucceeded:r];
            }
        }
            break;
        case DELETE_CUSTOMER_PROFILE_REQUEST:
        {
            NSLog(@"DeleteCustomerProfileResponse Response");
            NSLog(@"%@", responseString);
            DeleteCustomerProfileResponse *r = [DeleteCustomerProfileResponse parseDeleteCustomerProfileResponse:theResponse];
            self.response = r;
            if (r == nil) {
                self.response = [DeleteCustomerProfileResponse deleteCustomerProfileResponse];
                self.response.errorType = SERVER_ERROR;
                self.response.responseReasonText = responseString;
            }
            if ([self.response.anetApiResponse.messages.resultCode isEqualToString:@"Ok"] &&
                [self.delegate respondsToSelector:@selector(deleteCustomerProfileSucceeded:)]) {
                [self.delegate deleteCustomerProfileSucceeded:r];
            }
        }
            break;
        case DELETE_CUSTOMER_PAYMENT_PROFILE_REQUEST:
        {
            NSLog(@"DeleteCustomerPaymentProfileResponse Response");
            NSLog(@"%@", responseString);
            DeleteCustomerPaymentProfileResponse *r = [DeleteCustomerPaymentProfileResponse parseDeleteCustomerPaymentProfileResponse:theResponse];
            self.response = r;
            if (r == nil) {
                self.response = [DeleteCustomerProfileResponse deleteCustomerProfileResponse];
                self.response.errorType = SERVER_ERROR;
            ...
            if ([self.response.anetApiResponse.messages.resultCode isEqualToString:@"Ok"] &&
                [self.delegate respondsToSelector:@selector(deleteCustomerPaymentProfileSucceeded:)]) {
                [self.delegate deleteCustomerPaymentProfileSucceeded:r];
            }
        }
            break;
        case DELETE_CUSTOMER_SHIPPING_ADDRESS_REQUEST:
        {
            NSLog(@"DeleteCustomerShippingAddressResponse Response");
            NSLog(@"%@", responseString);
            DeleteCustomerShippingAddressResponse *r = [DeleteCustomerShippingAddressResponse parseDeleteCustomerShippingAddressResponse:theResponse];
            self.response = r;
            if (r == nil) {
                self.response = [DeleteCustomerShippingAddressResponse deleteCustomerShippingAddressResponse];
                self.response.errorType = SERVER_ERROR;
                self.response.responseReasonText = responseString;
            }
            if ([self.response.anetApiResponse.messages.resultCode isEqualToString:@"Ok"] &&
                [self.delegate respondsToSelector:@selector(deleteCustomerShippingAddressSucceeded:)]) {
                [self.delegate deleteCustomerShippingAddressSucceeded:r];
            }
        }
            break;
        case GET_CUSTOMER_PROFILE_REQUEST:
        {
            NSLog(@"GetCustomerProfileResponse Response");
            NSLog(@"%@", responseString);
            GetCustomerProfileResponse *r = [GetCustomerProfileResponse parseGetCustomerProfileResponse:theResponse];
            self.response = r;
            if (r == nil) {
                self.response = [GetCustomerProfileResponse getCustomerProfileResponse];
                self.response.errorType = SERVER_ERROR;
                self.response.responseReasonText = responseString;
            }
            if ([self.response.anetApiResponse.messages.resultCode isEqualToString:@"Ok"] &&
                [self.delegate respondsToSelector:@selector(getCustomerProfileSucceeded:)]) {
                [self.delegate getCustomerProfileSucceeded:r];
            }
        }
            break;
        case GET_CUSTOMER_PAYMENT_PROFILE_REQUEST:
        {
            NSLog(@"GetCustomerPaymentProfileResponse Response");
            NSLog(@"%@", responseString);
            GetCustomerPaymentProfileResponse *r = [GetCustomerPaymentProfileResponse parseGetCustomerPaymentProfileResponse:theResponse];
            self.response = r;
            if (r == nil) {
                self.response = [GetCustomerPaymentProfileResponse getCustomerPaymentProfileResponse];
                self.response.errorType = SERVER_ERROR;
                self.response.responseReasonText = responseString;
            }
            if ([self.response.anetApiResponse.messages.resultCode isEqualToString:@"Ok"] &&
                [self.delegate respondsToSelector:@selector(getCustomerPaymentProfileSucceeded:)]) {
                [self.delegate getCustomerPaymentProfileSucceeded:r];
            }
        }
            break;
        case GET_CUSTOMER_SHIPPING_ADDRESS:
        {
            NSLog(@"GetCustomerShippingAddressResponse Response");
            NSLog(@"%@", responseString);
            GetCustomerShippingAddressResponse *r = [GetCustomerShippingAddressResponse parseGetCustomerShippingAddressResponse:theResponse];
            self.response = r;
            if (r == nil) {
                self.response = [GetCustomerShippingAddressResponse getCustomerShippingAddressResponse];
                self.response.errorType = SERVER_ERROR;
                self.response.responseReasonText = responseString;
            }
            if ([self.response.anetApiResponse.messages.resultCode isEqualToString:@"Ok"] &&
                [self.delegate respondsToSelector:@selector(getCustomerShippingAddressSucceeded:)]) {
                [self.delegate getCustomerShippingAddressSucceeded:r];
            }
        }
            break;
        case GET_CUSTOMER_PROFILEIDS:
        {
            NSLog(@"GetCustomerProfileIdsResponse Response");
            NSLog(@"%@", responseString);
            GetCustomerProfileIdsResponse *r = [GetCustomerProfileIdsResponse parseGetCustomerProfileIdsResponse:theResponse];
            self.response = r;
            if (r == nil) {
                self.response = [GetCustomerProfileIdsResponse getCustomerProfileIdsResponse];
                self.response.errorType = SERVER_ERROR;
                self.response.responseReasonText = responseString;
            }
            if ([self.response.anetApiResponse.messages.resultCode isEqualToString:@"Ok"] &&
                [self.delegate respondsToSelector:@selector(getCustomerProfileIdsSucceeded:)]) {
                [self.delegate getCustomerProfileIdsSucceeded:r];
            }
        }
            break;
        case UPDATE_CUSTOMER_PROFILE:
        {
            NSLog(@"UpdateCustomerProfileResponse Response");
            NSLog(@"%@", responseString);
            UpdateCustomerProfileResponse *r = [UpdateCustomerProfileResponse parseUpdateCustomerProfileResponse:theResponse];
            self.response = r;
            if (r == nil) {
                self.response = [UpdateCustomerProfileResponse updateCustomerProfileResponse];
                self.response.errorType = SERVER_ERROR;
                self.response.responseReasonText = responseString;
            }
            if ([self.response.anetApiResponse.messages.resultCode isEqualToString:@"Ok"] &&
                [self.delegate respondsToSelector:@selector(updateCustomerProfileSucceeded:)]) {
                [self.delegate updateCustomerProfileSucceeded:r];
            }
        }
            break;
        case UPDATE_CUSTOMER_PAYMENT_PROFILE_REQUEST:
        {
            NSLog(@"UpdateCustomerPaymentProfileResponse Response");
            NSLog(@"%@", responseString);
            UpdateCustomerPaymentProfileResponse *r = [UpdateCustomerPaymentProfileResponse parseUpdateCustomerPaymentProfileResponse:theResponse];
            self.response = r;
            if (r == nil) {
                self.response = [GetCustomerProfileIdsResponse getCustomerProfileIdsResponse];
                self.response.errorType = SERVER_ERROR;
            ...
            if ([self.response.anetApiResponse.messages.resultCode isEqualToString:@"Ok"] &&
                [self.delegate respondsToSelector:@selector(updateCustomerPaymentProfileSucceeded:)]) {
                [self.delegate updateCustomerPaymentProfileSucceeded:r];
            }
        }
            break;
        case UPDATE_CUSTOMER_SHIPPING_ADDRESS_REQUEST:
        {
            NSLog(@"UpdateCustomerShippingAddressResponse Response");
            NSLog(@"%@", responseString);
            UpdateCustomerShippingAddressResponse *r = [UpdateCustomerShippingAddressResponse parseUpdateCustomerShippingAddressResponse:theResponse];
            self.response = r;
            if (r == nil) {
                self.response = [UpdateCustomerShippingAddressResponse updateCustomerShippingAddressResponse];
                self.response.errorType = SERVER_ERROR;
                self.response.responseReasonText = responseString;
            }
            if ([self.response.anetApiResponse.messages.resultCode isEqualToString:@"Ok"] &&
                [self.delegate respondsToSelector:@selector(updateCustomerShippingAddressSucceeded:)]) {
                [self.delegate updateCustomerShippingAddressSucceeded:r];
            }
        }
            break;
        case VALIDATE_CUSTOMER_PAYMENT_PROFILE_REQUEST:
        {
            NSLog(@"ValidateCustomerPaymentProfileResponse Response");
            NSLog(@"%@", responseString);
            ValidateCustomerPaymentProfileResponse *r = [ValidateCustomerPaymentProfileResponse parseValidateCustomerPaymentProfileResponse:theResponse];
            self.response = r;
            if (r == nil) {
                self.response = [ValidateCustomerPaymentProfileResponse validateCustomerPaymentProfileResponse];
                self.response.errorType = SERVER_ERROR;
                self.response.responseReasonText = responseString;
            }
            if ([self.response.anetApiResponse.messages.resultCode isEqualToString:@"Ok"] &&
                [self.delegate respondsToSelector:@selector(validateCustomerPaymentProfileSucceeded:)]) {
                [self.delegate validateCustomerPaymentProfileSucceeded:r];
            }
        }
            break;		default:
			break;
...
- (void) createCustomerProfileRequest:(CreateCustomerProfileRequest *)r {
    requestType = CREATE_CUSTOMER_PROFILE_REQUEST;
    [self makeRequest:r];
}
- (void) createCustomerPaymentProfileRequest:(CreateCustomerPaymentProfileRequest *)r {
    requestType = CREATE_CUSTOMER_PAYMENT_PROFILE_REQUEST;
    [self makeRequest:r];
}
- (void) createCustomerShippingAddressRequest:(CreateCustomerShippingAddressRequest *)r {
    requestType = CREATE_CUSTOMER_SHIPPING_ADDRESS_REQUEST;
    [self makeRequest:r];
}
- (void) createCustomerProfileTransactionRequest:(CreateCustomerProfileTransactionRequest *)r {
    requestType = CREATE_CUSTOMER_PROFILE_TRANSACTION;
    [self makeRequest:r];
}
- (void) deleteCustomerProfileRequest:(DeleteCustomerProfileRequest *)r {
    requestType = DELETE_CUSTOMER_PROFILE_REQUEST;
    [self makeRequest:r];
}
- (void) deleteCustomerPaymentProfileRequest:(DeleteCustomerPaymentProfileRequest *)r {
    requestType = DELETE_CUSTOMER_PAYMENT_PROFILE_REQUEST;
    [self makeRequest:r];
}
- (void) deleteCustomerShippingAddressRequest:(DeleteCustomerShippingAddressRequest *)r {
    requestType = DELETE_CUSTOMER_SHIPPING_ADDRESS_REQUEST;
    [self makeRequest:r];
}
- (void) getCustomerProfileRequest:(GetCustomerProfileRequest *)r {
    requestType = GET_CUSTOMER_PROFILE_REQUEST;
    [self makeRequest:r];
}
- (void) getCustomerPaymentProfileRequest:(GetCustomerPaymentProfileRequest *)r {
    requestType = GET_CUSTOMER_PAYMENT_PROFILE_REQUEST;
    [self makeRequest:r];
}
- (void) getCustomerShippingAddressRequest:(GetCustomerShippingAddressRequest *)r {
    requestType = GET_CUSTOMER_SHIPPING_ADDRESS;
    [self makeRequest:r];
}
- (void) getCustomerProfileIdsRequest:(GetCustomerProfileIdsRequest *)r {
    requestType = GET_CUSTOMER_PROFILEIDS;
    [self makeRequest:r];
}
- (void) updateCustomerProfileRequest:(UpdateCustomerProfileRequest *)r {
    requestType = UPDATE_CUSTOMER_PROFILE;
    [self makeRequest:r];
}
- (void) updateCustomerPaymentProfileRequest:(UpdateCustomerPaymentProfileRequest *)r {
    requestType = UPDATE_CUSTOMER_PAYMENT_PROFILE_REQUEST;
    [self makeRequest:r];
}
- (void) updateCustomerShippingAddressRequest:(UpdateCustomerShippingAddressRequest *)r {
    requestType = UPDATE_CUSTOMER_SHIPPING_ADDRESS_REQUEST;
    [self makeRequest:r];
}
- (void) validateCustomerPaymentProfileRequest:(ValidateCustomerPaymentProfileRequest *)r {
    requestType = VALIDATE_CUSTOMER_PAYMENT_PROFILE_REQUEST;
    [self makeRequest:r];
}
