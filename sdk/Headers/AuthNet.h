...
#import "DeleteCustomerProfileRequest.h"
...
#import "GetCustomerPaymentProfileRequest.h"
...
- (void) createCustomerShippingAddressSucceeded:(CreateCustomerShippingAddressResponse *)response;
- (void) createCustomerProfileTransactionSucceeded:(CreateCustomerProfileTransactionResponse *)response;
- (void) deleteCustomerProfileSucceeded:(DeleteCustomerProfileResponse *)response;
- (void) deleteCustomerPaymentProfileSucceeded:(DeleteCustomerPaymentProfileResponse *)response;
- (void) deleteCustomerShippingAddressSucceeded:(DeleteCustomerShippingAddressResponse *)response;
- (void) getCustomerProfileSucceeded:(GetCustomerProfileResponse *)response;
- (void) getCustomerPaymentProfileSucceeded:(GetCustomerPaymentProfileResponse *)response;
- (void) getCustomerShippingAddressSucceeded:(GetCustomerShippingAddressResponse *)response;
- (void) getCustomerProfileIdsSucceeded:(GetCustomerProfileIdsResponse *)response;
- (void) updateCustomerProfileSucceeded:(UpdateCustomerProfileResponse *)response;
- (void) updateCustomerPaymentProfileSucceeded:(UpdateCustomerPaymentProfileResponse *)response;
- (void) updateCustomerShippingAddressSucceeded:(UpdateCustomerShippingAddressResponse *)response;
- (void) validateCustomerPaymentProfileSucceeded:(ValidateCustomerPaymentProfileResponse *)response;
@end
