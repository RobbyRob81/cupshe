//
//  NSDictionary+CaseInsensitiveKeys.h
//
...
@interface NSDictionary (CaseInsensitiveKeys)

/**
 * Look up the value for _key_, matching _key_ in a case-insensitive manner
 *
 * \param key Case-insensitive key name
 * \returns value associated with the case-insensitive key _key_, or `nil`
 **/
...
@interface NSMutableDictionary (CaseInsensitiveKeys)

/**
 * Remove the value for the case-insensitive key _key_
 *
 * \param key Case-insensitive key name
 **/
