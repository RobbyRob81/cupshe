...
@implementation USAePayPaymentMethodArray

@synthesize items;

+ (USAePayPaymentMethodArray *)createWithXml:(DDXMLElement *)__node __request:(USAePayRequestResultHandler*) __request
{
...
- (id) initWithXml: (DDXMLElement*) __node __request:(USAePayRequestResultHandler*) __request {
    if(self = [self init])
    {
        ...
        {
            [self.items addObject:(USAePayPaymentMethod*)[__request createObject:child type:[USAePayPaymentMethod class]]];
        }
...
{
    for (USAePayPaymentMethod* item in self.items) {
        DDXMLElement* propertyElement=[__request writeElement:item type:[USAePayPaymentMethod class] name:@"PaymentMethod" URI:@"urn:usaepay" parent:__parent skipNullProperty:NO];
        if(propertyElement!=nil)
        {
            [item serialize:propertyElement __request: __request];
        }
    }
    [__request addAttribute:@"type" URI:@"http://www.w3.org/2001/XMLSchema" stringValue:@"xx2:PaymentMethodArray" element:__parent];
    [__request addAttribute:@"arrayType" URI:@"http://schemas.xmlsoap.org/soap/encoding/" stringValue:@"xx1:PaymentMethod[]" element:__parent];
...
- (USAePayPaymentMethod*)objectAtIndex:(NSUInteger)index {
	return [self.items objectAtIndex:index];
}

- (NSArray *)arrayByAddingObject:(USAePayPaymentMethod*)anObject {
...
- (BOOL)containsObject:(USAePayPaymentMethod*)anObject {
...
- (NSUInteger)indexOfObject:(USAePayPaymentMethod*)anObject {
	return [self.items indexOfObject:anObject];
}

- (NSUInteger)indexOfObject:(USAePayPaymentMethod*)anObject inRange:(NSRange)range {
	return [self.items indexOfObject:anObject inRange:range];
}

- (NSUInteger)indexOfObjectIdenticalTo:(USAePayPaymentMethod*)anObject {
	return [self.items indexOfObjectIdenticalTo:anObject];
}

- (NSUInteger)indexOfObjectIdenticalTo:(USAePayPaymentMethod*)anObject inRange:(NSRange)range {
...
- (USAePayPaymentMethod*)lastObject {
...
- (void)addObject:(USAePayPaymentMethod*)anObject {
	return [self.items addObject:anObject];
}

- (void)insertObject:(USAePayPaymentMethod*)anObject atIndex:(NSUInteger)index {
...
- (void)replaceObjectAtIndex:(NSUInteger)index withObject:(USAePayPaymentMethod*)anObject {
...
- (void)removeObject:(USAePayPaymentMethod*)anObject inRange:(NSRange)range {
	return [self.items removeObject:anObject inRange:range];
}

- (void)removeObject:(USAePayPaymentMethod*)anObject {
	return [self.items removeObject:anObject];
}

- (void)removeObjectIdenticalTo:(USAePayPaymentMethod*)anObject inRange:(NSRange)range {
	return [self.items removeObjectIdenticalTo:anObject inRange:range];
}

- (void)removeObjectIdenticalTo:(USAePayPaymentMethod*)anObject {
...
+ (id)array {
	return [[ USAePayPaymentMethodArray alloc] init];
}

+ (id)arrayWithObject:(USAePayPaymentMethod*)anObject {
	return [[ USAePayPaymentMethodArray alloc] initWithObjects:anObject, nil];
}

+ (id)arrayWithObjects:(const USAePayPaymentMethod* *)objects count:(NSUInteger)cnt {
	return [[ USAePayPaymentMethodArray alloc] initWithObjects:objects count:cnt];
}

+ (id)arrayWithObjects:(USAePayPaymentMethod*)firstObj, ... {
	USAePayPaymentMethodArray* a = [ USAePayPaymentMethodArray array];
	id eachObject;
...
- (id)initWithObjects:(USAePayPaymentMethod*)firstObj, ... {
	if(self = [self init]) {
		id eachObject;
		va_list argumentList;
		if (firstObj) {
...
+ (id)arrayWithArray:(NSArray *)array {
	return [[ USAePayPaymentMethodArray alloc] initWithArray:array];
}

+ (id)arrayWithContentsOfFile:(NSString *)path {
	return [[ USAePayPaymentMethodArray alloc] initWithContentsOfFile:path];
}

+ (id)arrayWithContentsOfURL:(NSURL *)url {
	return [[ USAePayPaymentMethodArray alloc] initWithContentsOfURL:url];
}

+ (id)arrayWithCapacity:(NSUInteger)numItems {
	return [[ USAePayPaymentMethodArray alloc] initWithCapacity:numItems];
}

- (id)initWithObjects:(const USAePayPaymentMethod* *)objects count:(NSUInteger)cnt {
	self = [self init];
	if(self) {
...
- (NSArray *)sortedArrayUsingFunction:(NSInteger (*)(USAePayPaymentMethod*, USAePayPaymentMethod*, void *))comparator context:(void *)context {
	return [self.items sortedArrayUsingFunction:comparator context:context];
}

- (NSArray *)sortedArrayUsingFunction:(NSInteger (*)(USAePayPaymentMethod*, USAePayPaymentMethod*, void *))comparator context:(void *)context hint:(NSData *)hint {
	return [self.items sortedArrayUsingFunction:comparator context:context hint:hint];
}

- (void)sortUsingFunction:(NSInteger (*)(USAePayPaymentMethod*, USAePayPaymentMethod*, void *))compare context:(void *)context {
