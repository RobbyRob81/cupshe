...
{
    DDXMLNode* child=[USAePayHelper getAttribute:node name:name];
    return child!=nil;
}
...
{
    DDXMLElement* child=[USAePayHelper getNode:node name:name index:index];
    if(child!=nil)
    {
        DDXMLNode* nilAttr=[USAePayHelper getAttribute:child name:@"nil" url:XSI];
        return nilAttr==nil;
    }
    return NO;
}
