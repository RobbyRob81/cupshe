...
@interface USAePayProductCategory : NSObject <USAePayISerializableObject>


@property (retain,nonatomic,getter=getProductCategoryRefNum) NSString* ProductCategoryRefNum;
