...
@implementation USAePayProductInventoryArray

@synthesize items;

+ (USAePayProductInventoryArray *)createWithXml:(DDXMLElement *)__node __request:(USAePayRequestResultHandler*) __request
{
...
- (id) initWithXml: (DDXMLElement*) __node __request:(USAePayRequestResultHandler*) __request {
    if(self = [self init])
    {
        ...
        {
            [self.items addObject:(USAePayProductInventory*)[__request createObject:child type:[USAePayProductInventory class]]];
        }
...
{
    for (USAePayProductInventory* item in self.items) {
        DDXMLElement* propertyElement=[__request writeElement:item type:[USAePayProductInventory class] name:@"ProductInventory" URI:@"urn:usaepay" parent:__parent skipNullProperty:NO];
        if(propertyElement!=nil)
        {
            [item serialize:propertyElement __request: __request];
        }
    }
    [__request addAttribute:@"type" URI:@"http://www.w3.org/2001/XMLSchema" stringValue:@"xx2:ProductInventoryArray" element:__parent];
    [__request addAttribute:@"arrayType" URI:@"http://schemas.xmlsoap.org/soap/encoding/" stringValue:@"xx1:ProductInventory[]" element:__parent];
...
- (USAePayProductInventory*)objectAtIndex:(NSUInteger)index {
	return [self.items objectAtIndex:index];
}

- (NSArray *)arrayByAddingObject:(USAePayProductInventory*)anObject {
...
- (BOOL)containsObject:(USAePayProductInventory*)anObject {
...
- (NSUInteger)indexOfObject:(USAePayProductInventory*)anObject {
	return [self.items indexOfObject:anObject];
}

- (NSUInteger)indexOfObject:(USAePayProductInventory*)anObject inRange:(NSRange)range {
	return [self.items indexOfObject:anObject inRange:range];
}

- (NSUInteger)indexOfObjectIdenticalTo:(USAePayProductInventory*)anObject {
	return [self.items indexOfObjectIdenticalTo:anObject];
}

- (NSUInteger)indexOfObjectIdenticalTo:(USAePayProductInventory*)anObject inRange:(NSRange)range {
...
- (USAePayProductInventory*)lastObject {
...
- (void)addObject:(USAePayProductInventory*)anObject {
	return [self.items addObject:anObject];
}

- (void)insertObject:(USAePayProductInventory*)anObject atIndex:(NSUInteger)index {
...
- (void)replaceObjectAtIndex:(NSUInteger)index withObject:(USAePayProductInventory*)anObject {
...
- (void)removeObject:(USAePayProductInventory*)anObject inRange:(NSRange)range {
	return [self.items removeObject:anObject inRange:range];
}

- (void)removeObject:(USAePayProductInventory*)anObject {
	return [self.items removeObject:anObject];
}

- (void)removeObjectIdenticalTo:(USAePayProductInventory*)anObject inRange:(NSRange)range {
	return [self.items removeObjectIdenticalTo:anObject inRange:range];
}

- (void)removeObjectIdenticalTo:(USAePayProductInventory*)anObject {
...
+ (id)array {
	return [[ USAePayProductInventoryArray alloc] init];
}

+ (id)arrayWithObject:(USAePayProductInventory*)anObject {
	return [[ USAePayProductInventoryArray alloc] initWithObjects:anObject, nil];
}

+ (id)arrayWithObjects:(const USAePayProductInventory* *)objects count:(NSUInteger)cnt {
	return [[ USAePayProductInventoryArray alloc] initWithObjects:objects count:cnt];
}

+ (id)arrayWithObjects:(USAePayProductInventory*)firstObj, ... {
	USAePayProductInventoryArray* a = [ USAePayProductInventoryArray array];
	id eachObject;
...
- (id)initWithObjects:(USAePayProductInventory*)firstObj, ... {
	if(self = [self init]) {
		id eachObject;
		va_list argumentList;
		if (firstObj) {
...
+ (id)arrayWithArray:(NSArray *)array {
	return [[ USAePayProductInventoryArray alloc] initWithArray:array];
}

+ (id)arrayWithContentsOfFile:(NSString *)path {
	return [[ USAePayProductInventoryArray alloc] initWithContentsOfFile:path];
}

+ (id)arrayWithContentsOfURL:(NSURL *)url {
	return [[ USAePayProductInventoryArray alloc] initWithContentsOfURL:url];
}

+ (id)arrayWithCapacity:(NSUInteger)numItems {
	return [[ USAePayProductInventoryArray alloc] initWithCapacity:numItems];
}

- (id)initWithObjects:(const USAePayProductInventory* *)objects count:(NSUInteger)cnt {
	self = [self init];
	if(self) {
...
- (NSArray *)sortedArrayUsingFunction:(NSInteger (*)(USAePayProductInventory*, USAePayProductInventory*, void *))comparator context:(void *)context {
	return [self.items sortedArrayUsingFunction:comparator context:context];
}

- (NSArray *)sortedArrayUsingFunction:(NSInteger (*)(USAePayProductInventory*, USAePayProductInventory*, void *))comparator context:(void *)context hint:(NSData *)hint {
	return [self.items sortedArrayUsingFunction:comparator context:context hint:hint];
}

- (void)sortUsingFunction:(NSInteger (*)(USAePayProductInventory*, USAePayProductInventory*, void *))compare context:(void *)context {
