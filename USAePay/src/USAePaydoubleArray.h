...
@interface USAePaydoubleArray : NSObject < NSCopying, NSMutableCopying, NSCoding, NSFastEnumeration>
...
+ (id)arrayWithObjects:(NSNumber*)firstObj, ... NS_REQUIRES_NIL_TERMINATION;
+ (id)arrayWithArray:(NSArray *)array;

- (id)initWithObjects:(const NSNumber* *)objects count:(NSUInteger)cnt;
- (id)initWithObjects:(NSNumber*)firstObj, ... NS_REQUIRES_NIL_TERMINATION;
