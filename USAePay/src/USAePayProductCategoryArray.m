...
@implementation USAePayProductCategoryArray

@synthesize items;

+ (USAePayProductCategoryArray *)createWithXml:(DDXMLElement *)__node __request:(USAePayRequestResultHandler*) __request
{
...
- (id) initWithXml: (DDXMLElement*) __node __request:(USAePayRequestResultHandler*) __request {
    if(self = [self init])
    {
        ...
        {
            [self.items addObject:(USAePayProductCategory*)[__request createObject:child type:[USAePayProductCategory class]]];
        }
...
{
    for (USAePayProductCategory* item in self.items) {
        DDXMLElement* propertyElement=[__request writeElement:item type:[USAePayProductCategory class] name:@"ProductCategory" URI:@"urn:usaepay" parent:__parent skipNullProperty:NO];
        if(propertyElement!=nil)
        {
            [item serialize:propertyElement __request: __request];
        }
    }
    [__request addAttribute:@"type" URI:@"http://www.w3.org/2001/XMLSchema" stringValue:@"xx2:ProductCategoryArray" element:__parent];
    [__request addAttribute:@"arrayType" URI:@"http://schemas.xmlsoap.org/soap/encoding/" stringValue:@"xx1:ProductCategory[]" element:__parent];
...
- (USAePayProductCategory*)objectAtIndex:(NSUInteger)index {
	return [self.items objectAtIndex:index];
}

- (NSArray *)arrayByAddingObject:(USAePayProductCategory*)anObject {
...
- (BOOL)containsObject:(USAePayProductCategory*)anObject {
...
- (NSUInteger)indexOfObject:(USAePayProductCategory*)anObject {
	return [self.items indexOfObject:anObject];
}

- (NSUInteger)indexOfObject:(USAePayProductCategory*)anObject inRange:(NSRange)range {
	return [self.items indexOfObject:anObject inRange:range];
}

- (NSUInteger)indexOfObjectIdenticalTo:(USAePayProductCategory*)anObject {
	return [self.items indexOfObjectIdenticalTo:anObject];
}

- (NSUInteger)indexOfObjectIdenticalTo:(USAePayProductCategory*)anObject inRange:(NSRange)range {
...
- (USAePayProductCategory*)lastObject {
...
- (void)addObject:(USAePayProductCategory*)anObject {
	return [self.items addObject:anObject];
}

- (void)insertObject:(USAePayProductCategory*)anObject atIndex:(NSUInteger)index {
...
- (void)replaceObjectAtIndex:(NSUInteger)index withObject:(USAePayProductCategory*)anObject {
...
- (void)removeObject:(USAePayProductCategory*)anObject inRange:(NSRange)range {
	return [self.items removeObject:anObject inRange:range];
}

- (void)removeObject:(USAePayProductCategory*)anObject {
	return [self.items removeObject:anObject];
}

- (void)removeObjectIdenticalTo:(USAePayProductCategory*)anObject inRange:(NSRange)range {
	return [self.items removeObjectIdenticalTo:anObject inRange:range];
}

- (void)removeObjectIdenticalTo:(USAePayProductCategory*)anObject {
...
+ (id)array {
	return [[ USAePayProductCategoryArray alloc] init];
}

+ (id)arrayWithObject:(USAePayProductCategory*)anObject {
	return [[ USAePayProductCategoryArray alloc] initWithObjects:anObject, nil];
}

+ (id)arrayWithObjects:(const USAePayProductCategory* *)objects count:(NSUInteger)cnt {
	return [[ USAePayProductCategoryArray alloc] initWithObjects:objects count:cnt];
}

+ (id)arrayWithObjects:(USAePayProductCategory*)firstObj, ... {
	USAePayProductCategoryArray* a = [ USAePayProductCategoryArray array];
	id eachObject;
...
- (id)initWithObjects:(USAePayProductCategory*)firstObj, ... {
	if(self = [self init]) {
		id eachObject;
		va_list argumentList;
		if (firstObj) {
...
+ (id)arrayWithArray:(NSArray *)array {
	return [[ USAePayProductCategoryArray alloc] initWithArray:array];
}

+ (id)arrayWithContentsOfFile:(NSString *)path {
	return [[ USAePayProductCategoryArray alloc] initWithContentsOfFile:path];
}

+ (id)arrayWithContentsOfURL:(NSURL *)url {
	return [[ USAePayProductCategoryArray alloc] initWithContentsOfURL:url];
}

+ (id)arrayWithCapacity:(NSUInteger)numItems {
	return [[ USAePayProductCategoryArray alloc] initWithCapacity:numItems];
}

- (id)initWithObjects:(const USAePayProductCategory* *)objects count:(NSUInteger)cnt {
	self = [self init];
	if(self) {
...
- (NSArray *)sortedArrayUsingFunction:(NSInteger (*)(USAePayProductCategory*, USAePayProductCategory*, void *))comparator context:(void *)context {
	return [self.items sortedArrayUsingFunction:comparator context:context];
}

- (NSArray *)sortedArrayUsingFunction:(NSInteger (*)(USAePayProductCategory*, USAePayProductCategory*, void *))comparator context:(void *)context hint:(NSData *)hint {
	return [self.items sortedArrayUsingFunction:comparator context:context hint:hint];
}

- (void)sortUsingFunction:(NSInteger (*)(USAePayProductCategory*, USAePayProductCategory*, void *))compare context:(void *)context {
