...
@implementation USAePaystringArray

@synthesize items;

+ (USAePaystringArray *)createWithXml:(DDXMLElement *)__node __request:(USAePayRequestResultHandler*) __request
{
...
-(void) serialize:(DDXMLElement*)__parent __request:(USAePayRequestResultHandler*) __request
{
    for (NSString* item in self.items) {
        DDXMLElement* propertyElement=[__request writeElement:item type:[NSString class] name:@"string" URI:@"http://www.w3.org/2001/XMLSchema" parent:__parent skipNullProperty:NO];
        if(propertyElement!=nil)
        {
            [propertyElement setStringValue:item];
        }
    }
    [__request addAttribute:@"type" URI:@"http://www.w3.org/2001/XMLSchema" stringValue:@"xx2:stringArray" element:__parent];
    [__request addAttribute:@"arrayType" URI:@"http://schemas.xmlsoap.org/soap/encoding/" stringValue:@"xx1:string[]" element:__parent];
...
+ (id)array {
	return [[ USAePaystringArray alloc] init];
}

+ (id)arrayWithObject:(NSString*)anObject {
	return [[ USAePaystringArray alloc] initWithObjects:anObject, nil];
}

+ (id)arrayWithObjects:(const NSString* *)objects count:(NSUInteger)cnt {
	return [[ USAePaystringArray alloc] initWithObjects:objects count:cnt];
}

+ (id)arrayWithObjects:(NSString*)firstObj, ... {
	USAePaystringArray* a = [ USAePaystringArray array];
	id eachObject;
...
+ (id)arrayWithArray:(NSArray *)array {
	return [[ USAePaystringArray alloc] initWithArray:array];
}

+ (id)arrayWithContentsOfFile:(NSString *)path {
	return [[ USAePaystringArray alloc] initWithContentsOfFile:path];
}

+ (id)arrayWithContentsOfURL:(NSURL *)url {
	return [[ USAePaystringArray alloc] initWithContentsOfURL:url];
}

+ (id)arrayWithCapacity:(NSUInteger)numItems {
	return [[ USAePaystringArray alloc] initWithCapacity:numItems];
}
