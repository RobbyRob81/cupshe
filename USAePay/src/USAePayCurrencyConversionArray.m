...
@implementation USAePayCurrencyConversionArray

@synthesize items;

+ (USAePayCurrencyConversionArray *)createWithXml:(DDXMLElement *)__node __request:(USAePayRequestResultHandler*) __request
{
...
- (id) initWithXml: (DDXMLElement*) __node __request:(USAePayRequestResultHandler*) __request {
    if(self = [self init])
    {
        ...
        {
            [self.items addObject:(USAePayCurrencyConversion*)[__request createObject:child type:[USAePayCurrencyConversion class]]];
        }
...
{
    for (USAePayCurrencyConversion* item in self.items) {
        DDXMLElement* propertyElement=[__request writeElement:item type:[USAePayCurrencyConversion class] name:@"CurrencyConversion" URI:@"urn:usaepay" parent:__parent skipNullProperty:NO];
        if(propertyElement!=nil)
        {
            [item serialize:propertyElement __request: __request];
        }
    }
    [__request addAttribute:@"type" URI:@"http://www.w3.org/2001/XMLSchema" stringValue:@"xx2:CurrencyConversionArray" element:__parent];
    [__request addAttribute:@"arrayType" URI:@"http://schemas.xmlsoap.org/soap/encoding/" stringValue:@"xx1:CurrencyConversion[]" element:__parent];
...
- (USAePayCurrencyConversion*)objectAtIndex:(NSUInteger)index {
	return [self.items objectAtIndex:index];
}

- (NSArray *)arrayByAddingObject:(USAePayCurrencyConversion*)anObject {
...
- (BOOL)containsObject:(USAePayCurrencyConversion*)anObject {
...
- (NSUInteger)indexOfObject:(USAePayCurrencyConversion*)anObject {
	return [self.items indexOfObject:anObject];
}

- (NSUInteger)indexOfObject:(USAePayCurrencyConversion*)anObject inRange:(NSRange)range {
	return [self.items indexOfObject:anObject inRange:range];
}

- (NSUInteger)indexOfObjectIdenticalTo:(USAePayCurrencyConversion*)anObject {
	return [self.items indexOfObjectIdenticalTo:anObject];
}

- (NSUInteger)indexOfObjectIdenticalTo:(USAePayCurrencyConversion*)anObject inRange:(NSRange)range {
...
- (USAePayCurrencyConversion*)lastObject {
...
- (void)addObject:(USAePayCurrencyConversion*)anObject {
	return [self.items addObject:anObject];
}

- (void)insertObject:(USAePayCurrencyConversion*)anObject atIndex:(NSUInteger)index {
...
- (void)replaceObjectAtIndex:(NSUInteger)index withObject:(USAePayCurrencyConversion*)anObject {
...
- (void)removeObject:(USAePayCurrencyConversion*)anObject inRange:(NSRange)range {
	return [self.items removeObject:anObject inRange:range];
}

- (void)removeObject:(USAePayCurrencyConversion*)anObject {
	return [self.items removeObject:anObject];
}

- (void)removeObjectIdenticalTo:(USAePayCurrencyConversion*)anObject inRange:(NSRange)range {
	return [self.items removeObjectIdenticalTo:anObject inRange:range];
}

- (void)removeObjectIdenticalTo:(USAePayCurrencyConversion*)anObject {
...
+ (id)array {
	return [[ USAePayCurrencyConversionArray alloc] init];
}

+ (id)arrayWithObject:(USAePayCurrencyConversion*)anObject {
	return [[ USAePayCurrencyConversionArray alloc] initWithObjects:anObject, nil];
}

+ (id)arrayWithObjects:(const USAePayCurrencyConversion* *)objects count:(NSUInteger)cnt {
	return [[ USAePayCurrencyConversionArray alloc] initWithObjects:objects count:cnt];
}

+ (id)arrayWithObjects:(USAePayCurrencyConversion*)firstObj, ... {
	USAePayCurrencyConversionArray* a = [ USAePayCurrencyConversionArray array];
	id eachObject;
...
- (id)initWithObjects:(USAePayCurrencyConversion*)firstObj, ... {
	if(self = [self init]) {
		id eachObject;
		va_list argumentList;
		if (firstObj) {
...
+ (id)arrayWithArray:(NSArray *)array {
	return [[ USAePayCurrencyConversionArray alloc] initWithArray:array];
}

+ (id)arrayWithContentsOfFile:(NSString *)path {
	return [[ USAePayCurrencyConversionArray alloc] initWithContentsOfFile:path];
}

+ (id)arrayWithContentsOfURL:(NSURL *)url {
	return [[ USAePayCurrencyConversionArray alloc] initWithContentsOfURL:url];
}

+ (id)arrayWithCapacity:(NSUInteger)numItems {
	return [[ USAePayCurrencyConversionArray alloc] initWithCapacity:numItems];
}

- (id)initWithObjects:(const USAePayCurrencyConversion* *)objects count:(NSUInteger)cnt {
	self = [self init];
	if(self) {
...
- (NSArray *)sortedArrayUsingFunction:(NSInteger (*)(USAePayCurrencyConversion*, USAePayCurrencyConversion*, void *))comparator context:(void *)context {
	return [self.items sortedArrayUsingFunction:comparator context:context];
}

- (NSArray *)sortedArrayUsingFunction:(NSInteger (*)(USAePayCurrencyConversion*, USAePayCurrencyConversion*, void *))comparator context:(void *)context hint:(NSData *)hint {
	return [self.items sortedArrayUsingFunction:comparator context:context hint:hint];
}

- (void)sortUsingFunction:(NSInteger (*)(USAePayCurrencyConversion*, USAePayCurrencyConversion*, void *))compare context:(void *)context {
