...
@implementation USAePayLineItemArray

@synthesize items;

+ (USAePayLineItemArray *)createWithXml:(DDXMLElement *)__node __request:(USAePayRequestResultHandler*) __request
{
...
- (id) initWithXml: (DDXMLElement*) __node __request:(USAePayRequestResultHandler*) __request {
    if(self = [self init])
    {
        ...
        {
            [self.items addObject:(USAePayLineItem*)[__request createObject:child type:[USAePayLineItem class]]];
        }
...
{
    for (USAePayLineItem* item in self.items) {
        DDXMLElement* propertyElement=[__request writeElement:item type:[USAePayLineItem class] name:@"LineItem" URI:@"urn:usaepay" parent:__parent skipNullProperty:NO];
        if(propertyElement!=nil)
        {
            [item serialize:propertyElement __request: __request];
        }
    }
    [__request addAttribute:@"type" URI:@"http://www.w3.org/2001/XMLSchema" stringValue:@"xx2:LineItemArray" element:__parent];
    [__request addAttribute:@"arrayType" URI:@"http://schemas.xmlsoap.org/soap/encoding/" stringValue:@"xx1:LineItem[]" element:__parent];
...
- (USAePayLineItem*)objectAtIndex:(NSUInteger)index {
	return [self.items objectAtIndex:index];
}

- (NSArray *)arrayByAddingObject:(USAePayLineItem*)anObject {
...
- (BOOL)containsObject:(USAePayLineItem*)anObject {
...
- (NSUInteger)indexOfObject:(USAePayLineItem*)anObject {
	return [self.items indexOfObject:anObject];
}

- (NSUInteger)indexOfObject:(USAePayLineItem*)anObject inRange:(NSRange)range {
	return [self.items indexOfObject:anObject inRange:range];
}

- (NSUInteger)indexOfObjectIdenticalTo:(USAePayLineItem*)anObject {
	return [self.items indexOfObjectIdenticalTo:anObject];
}

- (NSUInteger)indexOfObjectIdenticalTo:(USAePayLineItem*)anObject inRange:(NSRange)range {
...
- (void)addObject:(USAePayLineItem*)anObject {
	return [self.items addObject:anObject];
}

- (void)insertObject:(USAePayLineItem*)anObject atIndex:(NSUInteger)index {
...
- (void)replaceObjectAtIndex:(NSUInteger)index withObject:(USAePayLineItem*)anObject {
...
- (void)removeObject:(USAePayLineItem*)anObject inRange:(NSRange)range {
	return [self.items removeObject:anObject inRange:range];
}

- (void)removeObject:(USAePayLineItem*)anObject {
	return [self.items removeObject:anObject];
}

- (void)removeObjectIdenticalTo:(USAePayLineItem*)anObject inRange:(NSRange)range {
	return [self.items removeObjectIdenticalTo:anObject inRange:range];
}

- (void)removeObjectIdenticalTo:(USAePayLineItem*)anObject {
...
+ (id)array {
	return [[ USAePayLineItemArray alloc] init];
}

+ (id)arrayWithObject:(USAePayLineItem*)anObject {
	return [[ USAePayLineItemArray alloc] initWithObjects:anObject, nil];
}

+ (id)arrayWithObjects:(const USAePayLineItem* *)objects count:(NSUInteger)cnt {
	return [[ USAePayLineItemArray alloc] initWithObjects:objects count:cnt];
}

+ (id)arrayWithObjects:(USAePayLineItem*)firstObj, ... {
	USAePayLineItemArray* a = [ USAePayLineItemArray array];
	id eachObject;
...
- (id)initWithObjects:(USAePayLineItem*)firstObj, ... {
	if(self = [self init]) {
		id eachObject;
		va_list argumentList;
		if (firstObj) {
...
+ (id)arrayWithArray:(NSArray *)array {
	return [[ USAePayLineItemArray alloc] initWithArray:array];
}

+ (id)arrayWithContentsOfFile:(NSString *)path {
	return [[ USAePayLineItemArray alloc] initWithContentsOfFile:path];
}

+ (id)arrayWithContentsOfURL:(NSURL *)url {
	return [[ USAePayLineItemArray alloc] initWithContentsOfURL:url];
}

+ (id)arrayWithCapacity:(NSUInteger)numItems {
	return [[ USAePayLineItemArray alloc] initWithCapacity:numItems];
}

- (id)initWithObjects:(const USAePayLineItem* *)objects count:(NSUInteger)cnt {
	self = [self init];
	if(self) {
...
- (NSArray *)sortedArrayUsingFunction:(NSInteger (*)(USAePayLineItem*, USAePayLineItem*, void *))comparator context:(void *)context {
	return [self.items sortedArrayUsingFunction:comparator context:context];
}

- (NSArray *)sortedArrayUsingFunction:(NSInteger (*)(USAePayLineItem*, USAePayLineItem*, void *))comparator context:(void *)context hint:(NSData *)hint {
	return [self.items sortedArrayUsingFunction:comparator context:context hint:hint];
}

- (void)sortUsingFunction:(NSInteger (*)(USAePayLineItem*, USAePayLineItem*, void *))compare context:(void *)context {
